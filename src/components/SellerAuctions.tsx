...
import { getSellerAuctions } from '../fetchers/auctions'


export default function SellerAuctions(props: any) {
  ...
  useEffect(() => {
    const fetchAuctions = async () => {
      ...
      const [total, auctions] = await getSellerAuctions(provider, props.address, props.limit, offset)
  ...
  return (
    <>
      <Card.Header className='mb-2 mt-3'>
        <Row xs={1}>
